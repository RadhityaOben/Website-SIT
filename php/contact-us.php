		...
		<div class="row">
			...
			<div class="col-lg-6 d-flex align-items-center">
				<div class="container px-4 py-3">
					...
					Jika anda memiliki pertanyaan seputar produk kami, anda dapat menghubungi kami ke informasi kontak berikut atau langsung datang ke kantor kami di :
					<div class="container py-2">
						...
						<div class="row">
							...
							<div class="col-lg-11">
								<p>marketing@samuderainsanteknik.com</p>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-1">
							...
							<div class="col-lg-11">
								<p>Jl. Cisaranten Kulon No. 167, Arcamanik, Bandung, Jawa Barat 40293</p>
							</div>
						</div>
					</div>
				</div>
